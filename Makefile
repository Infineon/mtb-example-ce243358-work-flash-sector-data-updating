...
APPNAME=mtb-example-ce243358-work-flash-sector-data-updating
...
DEFINES=MTB_HAL_DISABLE_WEAK_FUNC_IMPL
...
# In CI, exclude syscall stubs that include sys/stat.h when toolchain headers differ.
ifneq ($(strip $(CI)),)
CY_IGNORE+=./syscalls.c
endif
